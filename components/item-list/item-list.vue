<template>
	<scroll-view class="item-list" scroll-y :scroll-top="scrollTop" @scrolltolower="scrolltolower" @scroll="scroll" lower-threshold="50">
		<view class="inner" :style="{ paddingTop: paddTop + 'px' }">
...
<script>
	export default {
		props: ['rurl', "rdata", "itemsShow", "paddTop"],
		data() {
			return {
				dataList: [],
				num: 1,
